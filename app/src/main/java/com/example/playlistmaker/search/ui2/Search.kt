...
class Search : AppCompatActivity(), TrackViewHolder.OnItemClickListener, SearchView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (searchPresenter == null) {
            searchPresenter = Creator.provideSearchPresenter(this.applicationContext)
    ...
    override fun onDestroy() {
        super.onDestroy()
        searchTextWatcher.let { binding.queryInput.removeTextChangedListener(it) }
        searchPresenter?.detachView()
